;==Summary======================================
;Run Google Chrome and open veoh
;Close Google Chrome
;===============================================
...
;Run Google Chrome and open veoh
Opt("SendKeyDelay",20)
Call("_wb_OpenWithPage","http://www.veoh.com/list/s/" & $SearchTerm,$VeohTitle)
Opt("SendKeyDelay",5)
Sleep(5000)
...
$finalcoordy=193 + $wincoords[1] + $coords1[1]
